...
As described in the learning notes specifically about [Properties](Properties.md), properties have a lot of potential use cases, such as creating read-only, read-write, and write-only attributes in an elegant way.
