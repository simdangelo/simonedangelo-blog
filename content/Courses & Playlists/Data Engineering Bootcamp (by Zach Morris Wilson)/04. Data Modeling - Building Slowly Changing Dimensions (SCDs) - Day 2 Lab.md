...
Then, we'll use the following query that creates the same table that we had from [02. Data Modeling - Cumulative Dimensions, Struct and Array - Day 1 Lab](02.%20Data%20Modeling%20-%20Cumulative%20Dimensions,%20Struct%20and%20Array%20-%20Day%201%20Lab.md):
```sql
INSERT INTO players  
WITH years AS (  
    SELECT *  
...
Output:
![](Pasted%20image%2020241202224354.png)
...
Output:
![](Pasted%20image%2020241202224812.png)
...
Output:
![](Pasted%20image%2020241202231011.png)
...
![](Pasted%20image%2020241202232313.png)
![](Pasted%20image%2020241202232205.png)
### Observations
...
![](Pasted%20image%2020241205220703.png)
...
![](Pasted%20image%2020241206220642.png)
...
Here's the output:
![](Pasted%20image%2020241207112027.png)
