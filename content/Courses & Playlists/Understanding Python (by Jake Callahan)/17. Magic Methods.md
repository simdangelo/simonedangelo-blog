...
In the [previous lesson](16.%20Class%20Inheritance.md) we have already seen **Magic Methods** like `__init__` and `__repr__`.
...
The screenshot:
![image.png](Courses%20&%20Playlists/Understanding%20Python%20(by%20Jake%20Callahan)/attachments/image.png)
