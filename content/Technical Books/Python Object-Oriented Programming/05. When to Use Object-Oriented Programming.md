...
*(I feel that topics like **setters**, **getters**, an **properties** are not clearly explained in the book, so I preferred to write two separate note articles about these topics: [Setters and Getters](Setters%20and%20Getters.md) and [Properties](Properties.md)*).
